  ...
  render() {
    ...
    return (
      <View style={!isPending ? styles.visible : styles.unvisible}>
        ...
        {/*Note on Deposit*/}
        <Modal
          isVisible={this.state.noteDeposit}
          avoidKeyboard={true}
          useNativeDriver={true}
          backdropColor='transparent'
          onBackdropPress={() => this.setState({ noteDeposit: false })}>
          <Card
            style={styles.dialog}
            ...
            <ScrollView
              ...
              <View styles={[styles.marginBottom5]}>
                <Text style={styles.contentRegular}>
            ...
            <TouchableOpacity
              ...
              onPress={() => this.setState({ noteDeposit: false, checked: true })}>
