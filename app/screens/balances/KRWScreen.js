      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ marginLeft: 20, marginRight: 20, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <View style={styles.noteContainer}>
            <Text style={{ flexWrap: 'wrap', fontSize: 13, fontWeight: 'bold' }}>1.&nbsp;
          ...
          {/* Note 2 */}
          <View style={styles.noteContainer}>
            <Text style={{ flexWrap: 'wrap', fontSize: 13, fontWeight: 'bold' }}>2.&nbsp;
          ...
          {/* Note 3 */}
          <View style={styles.noteContainer}>
            <Text style={{ flexWrap: 'wrap', fontSize: 13, fontWeight: 'bold' }}>3.&nbsp;
          ...
          {/* Note 4 */}
          <View style={styles.noteContainer}>
            <Text style={{ flexWrap: 'wrap', fontSize: 13, fontWeight: 'bold' }}>4.&nbsp;
          ...
          {/* Note 5 */}
          <View style={styles.noteContainer}>
            <Text style={{ flexWrap: 'wrap', fontSize: 13, fontWeight: 'bold' }}>5.&nbsp;
