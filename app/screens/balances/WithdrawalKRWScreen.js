...
const styles = ScaledSheet.create({
  ...
  smsInput: {
    ...
    borderWidth: '1@s', borderRadius: '4@s', borderColor: "rgba(0, 0, 0, 0.1)", lineHeight: '14@s', padding: 0
  },
  smsConfirmBtn: {
    flex: 1,
  ...
  optInput: { flex: 1, height: '30@s', textAlign: 'center', fontSize: '12@s', ...Fonts.NanumGothic_Regular, padding: 0, lineHeight: '14@s' },
